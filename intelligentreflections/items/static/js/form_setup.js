...
var form_handler = function(){
    ...
    class DataForm{
        ...
        static config_injection_regex = /@[\w_]+@/g;
        ...
        static extract_injection_key(key){
            ...
            }else if(utils.isObject(key, ['0', 'index'])){ // match Object
                return this.extract_injection_key(key[0]);
            }else{
            ...
            if(utils.isObject(config)){
                ...
                for(let [key, value] of Object.entries(config)){
                    if(utils.isString(value)){
                        ...
                        matches = value.match(this.config_injection_regex);
                        ...
                        if(value instanceof DataForm){
                            ...
                            // Recursion
                            let [cur, new_parsed] = this._parse_config_dict(value, value_dict, parsed_values);
        ...
        static generate_dom(config_dict){
            ...
            for(let [key, value] of Object.entries(config_dict)){
                ...
                cur_elem = dom_utils.create_element("br");
                container.appendChild(cur_elem);
            }
            return container;
        }
        ...
        static create_form(value_dict, parent_elem){
            ...
            let [config, _] = this.parse_config_dict(value_dict);
